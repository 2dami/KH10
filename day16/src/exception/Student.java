...
//field
	...
	public void setKorean(int korean) throws Exception {
		if( korean <0 || korean > 100) {
			//return;
			throw new Exception("국어점수는 0~100점으로만 설정 가능");
		}
		this.korean = korean;
	}
	...
	public void setEnglish(int english) throws Exception {
		if( english <0 || english > 100 ) {
			throw new Exception ("영어점수는 0~100점으로만 설정 가능");
		}
	...
	public void setMath(int math)  throws Exception {
		if( math <0 || math > 100 ) {
			throw new Exception ("수학점수는 0~100점으로만 설정 가능");
		}
		this.math = math;
	}
	public Student() {}
